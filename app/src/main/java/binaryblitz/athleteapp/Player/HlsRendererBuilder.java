package binaryblitz.athleteapp.Player;
...
public class HlsRendererBuilder implements GetFitPlayer.RendererBuilder {
  ...
  @Override
  public void buildRenderers(GetFitPlayer player) {
  ...
  private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
    ...
    private final Context context;
    private final String userAgent;
    private final GetFitPlayer player;
    private final ManifestFetcher<HlsPlaylist> playlistFetcher;

    private boolean canceled;

    public AsyncRendererBuilder(Context context, String userAgent, String url, GetFitPlayer player) {
      this.context = context;
      this.userAgent = userAgent;
      this.player = player;
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
      ...
      HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
          MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, GetFitPlayer.TYPE_VIDEO);
      ...
      if (haveSubtitles) {
        ...
        HlsSampleSource textSampleSource = new HlsSampleSource(textChunkSource, loadControl,
            TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, GetFitPlayer.TYPE_TEXT);
        textRenderer = new TextTrackRenderer(textSampleSource, player, mainHandler.getLooper());
      } else {
        textRenderer = new Eia608TrackRenderer(sampleSource, player, mainHandler.getLooper());
      }

      TrackRenderer[] renderers = new TrackRenderer[GetFitPlayer.RENDERER_COUNT];
      renderers[GetFitPlayer.TYPE_VIDEO] = videoRenderer;
      renderers[GetFitPlayer.TYPE_AUDIO] = audioRenderer;
      renderers[GetFitPlayer.TYPE_METADATA] = id3Renderer;
      renderers[GetFitPlayer.TYPE_TEXT] = textRenderer;
