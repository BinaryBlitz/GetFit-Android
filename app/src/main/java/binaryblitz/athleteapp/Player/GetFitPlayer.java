...
public class GetFitPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link GetFitPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link GetFitPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(GetFitPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link GetFitPlayer#onRenderers} or
     * {@link GetFitPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
  ...
  public GetFitPlayer(RendererBuilder rendererBuilder) {
   ...
   *
   * @param renderers Renderers indexed by {@link GetFitPlayer} TYPE_* constants. An individual
