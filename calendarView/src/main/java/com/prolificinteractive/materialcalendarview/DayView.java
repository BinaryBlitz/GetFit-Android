    ...
    protected void onDraw(@NonNull Canvas canvas) {
        if(isChecked()) {
            if (selectionDrawable != null) {
                ...
                selectionDrawable.setBounds(tempRect);
                selectionDrawable.setState(new int[] { android.R.attr.state_checked, android.R.attr.state_pressed, android.R.attr.state_focused});
